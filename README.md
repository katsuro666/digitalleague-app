# React todo project
TODO - SPA приложение для добавления / редактирования / удаления задач в общем пуле. Все задачи лежат на сервере, работа с ними осуществляется асинхронно. Есть возможность изменять состояние задач (важное, выполненное), организован поиск по задачам и фильтр по состоянию.
